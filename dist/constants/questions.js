...
import { checkUrl, getBrowserToRun, getPlaywrightDeviceDetailsObject, getUrlMessage, getFileSitemap, sanitizeUrlInput, validEmail, validName, validateCustomFlowLabel, parseHeaders, } from './common.js';
...
const startScanQuestions = [
    ...
    },
    {
        ...
        validate: async function (url, answers) {
            ...
            const res = await checkUrl(answers.scanner, url, browserToRun, clonedBrowserDataDir, playwrightDeviceDetailsObject, parseHeaders(answers.header), FileTypes.All);
    ...
    },
    {
        ...
        when: (answers) => answers.scanner === ScannerTypes.CUSTOM,
        validate: (label) => {
